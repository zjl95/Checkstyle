...
public final class TokenTypes {
    ...
    public static final int LOG_INFO =
            GeneratedJavaTokenTypes.LOG_INFO;
    
    public static final int LOG_DEBUG=
            GeneratedJavaTokenTypes.LOG_DEBUG;
    
    public static final int LOG_ERROR=
            GeneratedJavaTokenTypes.LOG_ERROR;
    
    public static final int LOG_WARN=
            GeneratedJavaTokenTypes.LOG_WARN;
    
    public static final int LOG_TRACE=
            GeneratedJavaTokenTypes.LOG_TRACE;
     */
